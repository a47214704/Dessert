  ...
  <div class="h-screen flex justify-center items-center px-4">
    <div class="bg-white px-4 py-6 rounded-md shadow">
      ...
      <div class="grid grid-cols-2 gap-2 gap-y-4 gap-x-0 mt-6">
        ...
        <input type="text" class="px-2 rounded border-2 border-slate-500" placeholder="請輸入使用者">
        <label class=" text-center font-bold">Password:</label>
        <input type="password" class="px-2 rounded border-2 border-slate-500" placeholder="請輸入密碼">
      </div>
      <button class="mt-8 px-4 py-2 bg-slate-700 text-white rounded hover:bg-slate-500" >登入</button>
    </div>
  </div>
</template>
